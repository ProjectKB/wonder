 ...
 */
final class Version20220322140613 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reset_password (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, expired_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('DROP INDEX IDX_5A108564F8697D13');
        $this->addSql('DROP INDEX IDX_5A1085641E27F6BF');
        $this->addSql('DROP INDEX IDX_5A108564F675F31B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__vote AS SELECT id, author_id, question_id, comment_id, is_liked FROM vote');
        $this->addSql('DROP TABLE vote');
        $this->addSql('CREATE TABLE vote (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, question_id INTEGER DEFAULT NULL, comment_id INTEGER DEFAULT NULL, is_liked BOOLEAN NOT NULL, CONSTRAINT FK_5A108564F675F31B FOREIGN KEY (author_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A1085641E27F6BF FOREIGN KEY (question_id) REFERENCES question (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A108564F8697D13 FOREIGN KEY (comment_id) REFERENCES comment (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO vote (id, author_id, question_id, comment_id, is_liked) SELECT id, author_id, question_id, comment_id, is_liked FROM __temp__vote');
