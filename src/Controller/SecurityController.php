...
class SecurityController extends AbstractController
{
    ...
    public function signup(Uploader $uploader, Request $request, EntityManagerInterface $em, UserPasswordHasherInterface $passwordHasher, UserAuthenticatorInterface $userAuthenticator, LoginFormAuthenticator $loginForm, MailerInterface $mailer)
    {
        $user = new User();
